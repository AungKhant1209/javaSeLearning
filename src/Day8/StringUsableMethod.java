...
//        char H=Integer.valueOf(1);
//        System.out.print(H);
//        int I=Integer.valueOf(1);
//        int V=Integer.valueOf(10);
//        System.out.println(I+V);
//        String ten=String.valueOf(10);
//        System.out.println(ten); // Output: 10
        String text="Where do you go go ?";
...
//
//        String friends=String.format("We are friend of  %s , %s","Felix","Wai Yan","Aung Khant");
